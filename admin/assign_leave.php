	...
	<section>
		...
		<div class="header">
			<div class="header-inside shadow bg-light">
				<p style="margin-top: 8px;margin-left: 8px;"><b>Assign Leave</b></p>
				
				<hr>
				<div class="col-md-1">
					<a style="float:left; margin-left: 3px;" class="btn btn-lg btn-outline-info" href="assign_leave_display.php">show Assign leave</a>
				</div>
				<div class="row">
					<form action="assign_leave_insert.php" method="POST">
						<input type="hidden" name="assign_by" value="<?php echo $_SESSION['admin_id']; ?>">
						<input type="hidden" name="assign" value="<?php echo $_SESSION['admin_name']; ?>">
