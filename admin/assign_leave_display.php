...
<body>
	...
	<section>
		<div class="header card-body ">
				...
				while ($result=mysqli_fetch_array($query)) {
				 ...
				 <tr>
				 	...
				 	<td>
				 		...
				 		<a class="btn btn-sm btn-outline-info" href="grant_emp_leave.php?id=<?php echo $result['id']; ?>">assign leave</a>
				 	</td>
			...
			<a href="all_assign_leave.php"><button type="button" class="btn btn-sm btn-outline-danger btn block form-control">all assign leave</button></a>
